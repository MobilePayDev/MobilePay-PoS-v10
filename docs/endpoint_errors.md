...
| 409 | 1000 <br> 1204 <br> 1301 <br> 1306`` `` <br> </p> | Point of Sale not found <br> Store to given PoS is not activated. Please activate store before starting payment <br> A payment is already active. Cancel it before starting a new one <br> ``x-mobilepay-idempotency-key`` header has to be unique per request unless the request is a retry of a previous request <br>  |
